...
export default function MainPage() {
  	...
  	return (
		<div className="animate-bg max-w-full max-h-full h-screen bg-radial-[at_50%_55%] from-gray-950 via-60% via-gray-900 to-gray-900 to-90%">
			<div className="flex justify-center items-center max-w-full h-full max-h-2/3">
				<img src="/images/title.png" alt="Title" className="animate-title h-[50vh]"/>
			</div>
