  ...
  return (
    <div className="animate-bg max-w-full h-239 bg-radial-[at_50%_55%] from-gray-950 via-gray-950 to-gray-900 to-90%">
        ...
        <div className="flex justify-center items-center max-w-full h-full max-h-1/3 gap-5.5">
          <button type="button" onClick={() => window.location.href = '/join-lobby'} className="bg-gradient-to-r from-rose-500 via-red-700 to-red-800 
          ...
          <button type="button" onClick={() => window.location.href = '/create-lobby'} className="text-gray-200 bg-gradient-to-r from-gray-700 via-gray-800 to-gray-900 
