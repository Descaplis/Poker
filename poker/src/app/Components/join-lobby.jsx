...
export default function JoinLobby(){
    ...
    return (
        <div className="max-w-full h-239 bg-radial-[at_50%_55%] from-gray-950 via-gray-950 to-gray-900 to-90%">
            ...
            <form id="join-form" className="p-5 flex flex-col items-center">
                ...
                <div className="flex flex-row mt-20">
                    ...
                    <button type="button" onClick={() => window.location.href = '/'} className="bg-gradient-to-r from-green-400 via-green-500 to-green-600
