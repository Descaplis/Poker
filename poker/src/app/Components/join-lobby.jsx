...
export default function JoinLobby(){
    ...
    return (
        <>
            ...
            <div className="animate-bg max-w-full h-screen bg-radial-[at_50%_55%] from-gray-950 via-gray-950 to-gray-900 to-90%">
                ...
                <form id="join-form" className="p-5 flex flex-col items-center">
                    ...
                    <div className="flex flex-row mt-20">
                        ...
                        <button type="button" onClick={() => router.back()} className="bg-linear-to-r from-green-400 via-green-500 to-green-600
                            hover:bg-linear-to-br focus:ring-4 focus:shadow-2xl focus:shadow-green-300 dark:focus:ring-green-700 
